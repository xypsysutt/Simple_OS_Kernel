...
void OS(){
    char cmd='\0';
    u16 addr[6]={0,0x1000,0x1000,0x1000,0x1000,0x1000};
    while(1){
        _CLS();
        help();
        cmd=_getchar();
        ...
        if(cmd<=4){
            ...
            "Prog1  |1       |1024   |0x1000h \r\n"
            "Prog2  |3       |1024   |0x1000h \r\n"
            "Prog3  |5       |1024   |0x1000h \r\n"
            "Prog4  |7       |1024   |0x1000h \r\n"
            "syscall|9       |1024   |0x1000h \r\n";
            print(PCB);
            _getchar();
        }
        else if(cmd == 7){
            ...
            int a = 178;
            char ch = 'A';
            myPrintf("ch=%c, a=%d, str=%s", ch, a, str);
            _getchar();
        }
        else{
            _CLS();
